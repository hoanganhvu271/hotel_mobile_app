                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            submitReview(
                                content, localSelectedStars, bookingId);
            ...
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  String checkInDate =
                      dateFormat.format(DateTime.parse(booking.checkIn));
                  String checkOutDate =
                      dateFormat.format(DateTime.parse(booking.checkOut));
                  String createdAtDate =
                      dateFormat.format(DateTime.parse(booking.createdAt));
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text('Địa chỉ: ${room.specificAddress}',
                                    style: const TextStyle(fontSize: 12)),
                                Text('Ngày nhận: $checkInDate',
                                    style: const TextStyle(fontSize: 12)),
                                Text('Ngày trả: $checkOutDate',
                                    style: const TextStyle(fontSize: 12)),
                                Text('Ngày tạo: $createdAtDate',
                                    style: const TextStyle(fontSize: 12)),
                              ],
                            ),
                          ),
