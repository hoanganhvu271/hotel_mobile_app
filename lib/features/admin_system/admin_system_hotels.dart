...
//   void filterUsers(List<User> allUsers, String query) {
//     setState(() {
//       searchQuery = query;
...
//                 labelText: 'Tìm kiếm theo ID, tên, username, sdt, email...',
...
//                   final displayUsers = searchQuery.isEmpty ? allUsers : filteredUsers;
//
...
//                               context,
//                               MaterialPageRoute(
//                                 builder: (context) => HotelListScreen(userId: user.id),
//                               ),
//                             );
//                           },
//                         ),
